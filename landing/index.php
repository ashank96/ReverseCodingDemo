...
<!--/.Navigation-->
		...
		<div class="row display-xs" style="padding-top:65px;padding-bottom:20px;width:100%">
								<div class="row text-center" style="width:100%;margin-left:10px;margin-right:0px">
									<div class="col-md-12"><h1 class="h1-responsive"  >Welcome to the website of<strong>DeCoders</strong></h1></div>
									<p>Where coding begins all over again</p>

									<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="www.google.com">Member Login
									</button>
								</div>
        ...
        <!--poster for insight 17-->
      <!--<div class="text-center">
          <a href="../insight17"><img src="../commonResources/img/cover.jpg" class="shift img-fluid" alt="">
      </div>-->
      <!--poster for insight 17 //-->
			...
			<!--card 1 start-->
						...
						<div class="card">
							<div class="um-events-tile">
									<div class="row story-heading">
										<div class="col-md-12">
											<h3 class="pull-left" style="font-family:'tahoma';font-size:1.5rem;marging:0">Upcoming Events</h3>

											<p class="text-right small pull-right" style="padding-top: 20px;">Today is <?php echo date("d/m/Y"); ?> </p>
										</div>
									</div>
              ...
              <!--      <div class="row event ">
                      <div class="col-sm-10 col-xs-9 text-left pull-right story-content">
                          ...
                          <a href="../insight17">
                            <h6 class="title"><b>inSight 2017</b></h6>
                          </a>
